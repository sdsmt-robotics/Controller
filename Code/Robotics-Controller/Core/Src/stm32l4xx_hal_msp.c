...
void HAL_ADC_MspInit(ADC_HandleTypeDef* hadc)
{
  ...
  */
    ...
    PA2     ------> ADC1_IN7
    */
    GPIO_InitStruct.Pin = JOY_V1_Pin|JOY_V2_Pin|JOY_H1_Pin|JOY_H2_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG_ADC_CONTROL;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(GPIOC, &GPIO_InitStruct);

    GPIO_InitStruct.Pin = HALL_1_Pin|HALL_2_Pin|VBAT_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG_ADC_CONTROL;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    PA2     ------> ADC1_IN7
    */
    HAL_GPIO_DeInit(GPIOC, JOY_V1_Pin|JOY_V2_Pin|JOY_H1_Pin|JOY_H2_Pin);

    HAL_GPIO_DeInit(GPIOA, HALL_1_Pin|HALL_2_Pin|VBAT_Pin);
